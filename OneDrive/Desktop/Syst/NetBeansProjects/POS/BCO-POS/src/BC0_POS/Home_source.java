...
public class Home_source {
    ...
    public void scave(JPanel start, JPanel start1, JPanel start2, JPanel start3, JPanel start4, JPanel start5, JPanel start6, JPanel start7, JPanel start8) {
    ...
    public static Connection mycon() {
        ...
        try {
            ...
            con = DriverManager.getConnection("jdbc:mysql://localhost:3306/siadb", "root", "");
            return con;
